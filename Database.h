...
private:
	...
	bool createFilesUsers(int fileId, int userId, std::string downloaded, std::string uploaded, std::string left);
	bool updateFilesUsers(int fileId, int userId, std::string downloaded, std::string uploaded, std::string left, int event);
